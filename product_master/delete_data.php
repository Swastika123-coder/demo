...
if ($userDetails['delete_permissioin'] == 'Yes') {
    ...
    //  GET ALL POST DATA 
    $customer_code = mysqli_real_escape_string($con, $postData['product_code']);

    mysqli_query($con,"delete from product_master where product_code='".$product_code."' ");

    $status = "Success";
    $message = "Customer Data Deleted Successfully";
    $activity_details = "You Delete A Record In Product";
